...
<textarea readonly="readonly" onclick="this.focus();this.select()" id="system-info-textarea" name="fts-sysinfo" title="<?php _e( 'To copy the system info, click below then press Ctrl + C (PC) or Cmd + C (Mac).', 'feed-them-social' ); ?>">
### Begin System Info ###
...
function wpb_find_shortcode_slick($atts, $content=null) { 
ob_start();
...
add_shortcode('shortcodefinderSlick', 'wpb_find_shortcode_slick'); 